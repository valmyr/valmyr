...
void contaBancaria::fazer_Deposito() {
    ...
    if(Deposito < 0) {
        //Se o deposito for menor que que zero ele o usuário recebe a mensagem "Deposito não autorizado"  e tem duas opções para escolher
        //[1] Sair [2] Tentar novamente
        cout << "Deposito não autorizado\n";
        cout << "Deseja: "<<endl<<" [1] Sair"<<" [2] Tentar novamente"<<endl;
        cin >> op;
        while (op < 1 || op > 2) {
            //Caso seja maior que 2 e menor que 1 o usuário recebe a mensagem "Opção invalida" e "Tente novamenete"
            cout << "Opcao invalida\n";
