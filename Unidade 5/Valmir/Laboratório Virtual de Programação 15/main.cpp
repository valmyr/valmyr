    ...
    while(true) {
        ...
        switch(op){
            case 1:
                ...
                break;
            case 2:
                //caso 2 o usuário escolhel imprimindo lista
                lN.imprimirLista();
                break;
            case 3:
                //caso 3 o usuário escolhel ordenar lista
                lN.ordenarNomes();
                cout<<"Lista Ordenada"<<endl;
                break;
            case 4:
                //caso 4 o usuário escolhel mostrar total de nomes na lista
                cout<<"Total: "<<Lista::getdNomes()<<endl;
                break;
            case 5:
                //caso 5 o usuário escolhel limpar a tela
                system("cls");
                break;
            default:
                //caso 6 o usuário escolhel fechar
                return 0;
        }
    }
}
