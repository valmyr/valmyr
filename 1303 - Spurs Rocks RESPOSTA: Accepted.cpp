...
class SpursRocks{
    private:
        ...
        int pontos;
    public:
        SpursRocks(int = 0,int = 0, int = 0, int =0);
        void setPontos(int);
...
SpursRocks::SpursRocks(int inscricaoNaLiga,int pontos,int marcados, int recebidos){
...
void classificador(vector<SpursRocks>classif){
